...
export const Footer = () => {
  return (
    <footer className="bg-belek-black text-white pt-12 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mb-4 text-gray-300">
              Лучший выбор бытовой техники от ведущих производителей в Кыргызстане
            </p>
            <div className="flex items-center space-x-4 mt-6">
              {/* Social media icons */}
              <a href="#" className="bg-white/10 hover:bg-belek-red p-2 rounded-full transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><Link to="/delivery" className="hover:text-belek-red transition-colors">Доставка и оплата</Link></li>
              <li><Link to="/return" className="hover:text-belek-red transition-colors">Возврат товара</Link></li>
              <li><Link to="/warranty" className="hover:text-belek-red transition-colors">Гарантия</Link></li>
              <li><Link to="/faq" className="hover:text-belek-red transition-colors">Часто задаваемые вопросы</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-300">
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-0.5 text-belek-red" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="border-t border-gray-800 mt-10 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 Белек Техника. Все права защищены.
            </p>
            <div className="mt-4 md:mt-0">
              <div className="flex items-center space-x-3">
                <img src="/placeholder.svg" alt="Visa" className="h-8" />
                <img src="/placeholder.svg" alt="MasterCard" className="h-8" />
                <img src="/placeholder.svg" alt="Мбанк" className="h-8" />
                <img src="/placeholder.svg" alt="Бакай Банк" className="h-8" />
              </div>
            </div>
          </div>
        </div>
